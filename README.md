<h1 align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=26&duration=3000&pause=800&color=00FF41&center=true&vCenter=true&width=650&lines=%24+whoami;%3E+Khaled+Samy+%3A%3A+programmer;%3E+access+granted+_" alt="typing banner" />
</h1>
...
user:
  name: Khaled Samy
  role: programmer / student of the terminal arts
  main_language: Python
  learning: [ advanced git, github workflows, algorithms ]
  interests: [ coding, learning new things, video games ]
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=py,git,github,githubactions,linux,bash,vscode,markdown&theme=dark" alt="stack" />
</p>
...
| project | description |
| :-- | :-- |
| [**Magic-8-Ball**](https://github.com/KHALEDSAMY1/Magic-8-Ball) | A Magic 8-Ball simulator that answers yes/no questions. |
| [**to-do-task**](https://github.com/KHALEDSAMY1/to-do-task) | A task manager — add, delete and view your tasks. |
